...
namespace sop {
    ...
    public:
        ...
        inline UIWidgetId GetId() const { return m_Id; }
        ...
        inline explicit operator bool() const { return m_Id != g_InvalidWidgetId; }
    protected:
        inline UIScreen& GetScreen() const { return m_Screen; }
    private:
        UIScreen& m_Screen;
